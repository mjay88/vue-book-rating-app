...
<template>
	<Transition
		appear
		enter-active-class="transition-opacity duration-1000 ease transition-transform duration-1000 ease"
		leave-active-class="transition-opacity duration-1000 ease transition-transform duration-1000 ease"
